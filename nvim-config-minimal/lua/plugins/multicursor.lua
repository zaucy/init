return {
	{
		...
		config = function()
			...
			vim.keymap.set({ "n", "v" }, "gM", function() require("which-key").show({ keys = "gm", loop = true }) end,
				{ desc = "Multicursor Hydra" })
			...
			vim.keymap.set({ "n", "v" }, "gm<up>", function() mc.lineAddCursor(-1) end,
				{ desc = "Add cursor prev line" })
			vim.keymap.set({ "n", "v" }, "gmk", function() mc.lineAddCursor(-1) end, { desc = "Add cursor prev line" })
			vim.keymap.set({ "n", "v" }, "gm<down>", function() mc.lineAddCursor(1) end,
				{ desc = "Add cursor next line" })
			vim.keymap.set({ "n", "v" }, "gmj", function() mc.lineAddCursor(1) end, { desc = "Add cursor next line" })
			vim.keymap.set("v", "gm<A-Up>", function() mc.transposeCursors(1) end,
			...
			vim.keymap.set("n", "gmw", function() mc.addCursor("w") end, { desc = "Add cursor next word" })
			vim.keymap.set("n", "gmW", function() mc.addCursor("W") end, { desc = "Add cursor next WORD" })
			vim.keymap.set("n", "gmb", function() mc.addCursor("b") end, { desc = "Add cursor prev word" })
			vim.keymap.set("n", "gmB", function() mc.addCursor("B") end, { desc = "Add cursor prev WORD" })
			vim.keymap.set("n", "gme", function() mc.addCursor("e") end, { desc = "Add cursor end of word" })
			vim.keymap.set("n", "gmE", function() mc.addCursor("E") end, { desc = "Add cursor end of WORD" })
			vim.keymap.set("n", "gm$", function() mc.addCursor("$") end, { desc = "Add cursor end of line" })
			vim.keymap.set("n", "gm0", function() mc.addCursor("0") end, { desc = "Add cursor start of line" })

			-- char motions
			vim.keymap.set("n", "gmf", function() mc.addCursor("f" .. vim.fn.nr2char(vim.fn.getchar())) end,
				{ desc = "Add cursor at next char" })
			vim.keymap.set("n", "gmF", function() mc.addCursor("F" .. vim.fn.nr2char(vim.fn.getchar())) end,
				{ desc = "Add cursor at prev char" })
			vim.keymap.set("n", "gmt", function() mc.addCursor("t" .. vim.fn.nr2char(vim.fn.getchar())) end,
				{ desc = "Add cursor at before next char" })
			vim.keymap.set("n", "gmT", function() mc.addCursor("T" .. vim.fn.nr2char(vim.fn.getchar())) end,
				{ desc = "Add cursor at before prev char" })
		end
	},
	{
		"zaucy/mcos.nvim",
